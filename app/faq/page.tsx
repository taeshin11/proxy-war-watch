...
export const metadata: Metadata = {
  ...
  description: 'How to use Proxy War Watch. Frequently asked questions about data, methodology, and features.',
  keywords: 'proxy war, foreign intervention, state sponsorship, arms network, proxy conflict, foreign fighters, FAQ, how to use, guide',
}

export default function FaqPage() {
  const faqs = [
    { q: 'What is Proxy War Watch and who is it for?', a: 'Proxy War Watch is a free, publicly accessible platform that maps proxy warfare networks, foreign interventions, and state sponsorship of armed groups in active conflicts. Designed for journalists, researchers, policy analysts, students, and NGO workers. No registration or payment required.' },
    ...
    { q: 'Is this platform free?', a: 'Proxy War Watch is entirely free with no registration required. It is sustained through advertising revenue. There are no paywalls or premium tiers.' },
    { q: 'Can I cite this data in my research?', a: 'Yes, with attribution to the platform and original primary source. For academic publications, cross-reference against primary sources. For partnerships or bulk access, contact us at contact@proxy-war-watch.vercel.app.' }
  ]
  return (
    <main className="bg-slate-50 min-h-screen">
      <div className="max-w-4xl mx-auto px-4 py-12">
        ...
        <h1 className="text-4xl font-bold text-slate-900 mb-4">How to Use Proxy War Watch</h1>
