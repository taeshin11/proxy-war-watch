...
export const metadata: Metadata = {
  ...
  description: 'Proxy War Watch Terms of Service — rules and conditions for use of our platform.',
...
export default async function TermsPage({ params }: { params: Promise<{ locale: string }> }) {
  ...
  const sections = [
    { title: '1. Acceptance of Terms', content: 'By accessing Proxy War Watch at proxy-war-watch.vercel.app, you agree to these Terms. If you disagree, please discontinue use. We may modify terms; continued use constitutes acceptance.' },
    { title: '2. Description of Service', content: 'Proxy War Watch is a free, publicly accessible platform that maps proxy warfare networks, foreign interventions, and state sponsorship of armed groups in active conflicts. Provided for informational and educational purposes only.' },
    ...
    { title: '4. Limitation of Liability', content: 'Proxy War Watch SHALL NOT BE LIABLE FOR ANY INDIRECT, INCIDENTAL, OR CONSEQUENTIAL DAMAGES. Total liability shall not exceed $0, as the Service is entirely free.' },
    ...
    { title: '10. Contact', content: 'Questions? Contact us at contact@proxy-war-watch.vercel.app.' },
  ]
  return (
