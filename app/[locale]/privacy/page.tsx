...
export const metadata: Metadata = {
  ...
  description: 'Proxy War Watch Privacy Policy — how we collect, use, and protect your information.',
...
export default async function PrivacyPage({ params }: { params: Promise<{ locale: string }> }) {
  ...
  const sections = [
    { title: '1. Introduction', content: 'Proxy War Watch operates the website at proxy-war-watch.vercel.app. This Privacy Policy explains how we collect, use, disclose, and safeguard your information when you visit our website.' },
